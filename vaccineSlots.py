...
def run():
    ...
    def create_output(session_info):
        return f"{session_info['date']} - {session_info['name']} ({session_info['capacity']}) ({session_info['vaccine']})"
    ...
    username = "life121earth@gmail.com"
    password = "Life@3160"
    ...
    if not content:
        ...
        email_msg["To"] = "akashmaurya368@gmail.com"
